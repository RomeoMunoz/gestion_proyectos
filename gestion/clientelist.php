...
fclientelist.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fclientelist.Lists["x_estado"].Options = <?php echo json_encode($cliente->estado->Options()) ?>;
fclientelist.Lists["x_tipo"] = {"LinkField":"x_idClienteTipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php
	...
	if ($cliente->CurrentAction == "" && $cliente_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$cliente_list->setWarningMessage(ew_DeniedMsg());
	...
	if ($cliente_list->AuditTrailOnSearch && $cliente_list->Command == "search" && !$cliente_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $cliente_list->getSessionWhere();
		$cliente_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
...
<option value="50"<?php if ($cliente_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
...
<?php if ($cliente->idCliente->Visible) { // idCliente ?>
	<?php if ($cliente->SortUrl($cliente->idCliente) == "") { ?>
		<th data-name="idCliente"><div id="elh_cliente_idCliente" class="cliente_idCliente"><div class="ewTableHeaderCaption"><?php echo $cliente->idCliente->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="idCliente"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->idCliente) ?>',1);"><div id="elh_cliente_idCliente" class="cliente_idCliente">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->idCliente->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($cliente->idCliente->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->idCliente->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($cliente->cliente->Visible) { // cliente ?>
	<?php if ($cliente->SortUrl($cliente->cliente) == "") { ?>
		<th data-name="cliente"><div id="elh_cliente_cliente" class="cliente_cliente"><div class="ewTableHeaderCaption"><?php echo $cliente->cliente->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="cliente"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->cliente) ?>',1);"><div id="elh_cliente_cliente" class="cliente_cliente">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->cliente->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($cliente->cliente->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->cliente->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($cliente->direccion->Visible) { // direccion ?>
	<?php if ($cliente->SortUrl($cliente->direccion) == "") { ?>
		<th data-name="direccion"><div id="elh_cliente_direccion" class="cliente_direccion"><div class="ewTableHeaderCaption"><?php echo $cliente->direccion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="direccion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->direccion) ?>',1);"><div id="elh_cliente_direccion" class="cliente_direccion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->direccion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($cliente->direccion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->direccion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($cliente->estado->Visible) { // estado ?>
	<?php if ($cliente->SortUrl($cliente->estado) == "") { ?>
		<th data-name="estado"><div id="elh_cliente_estado" class="cliente_estado"><div class="ewTableHeaderCaption"><?php echo $cliente->estado->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="estado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->estado) ?>',1);"><div id="elh_cliente_estado" class="cliente_estado">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->estado->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($cliente->estado->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->estado->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($cliente->tipo->Visible) { // tipo ?>
	<?php if ($cliente->SortUrl($cliente->tipo) == "") { ?>
		<th data-name="tipo"><div id="elh_cliente_tipo" class="cliente_tipo"><div class="ewTableHeaderCaption"><?php echo $cliente->tipo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tipo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->tipo) ?>',1);"><div id="elh_cliente_tipo" class="cliente_tipo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->tipo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($cliente->tipo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->tipo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($cliente->descripcion->Visible) { // descripcion ?>
	<?php if ($cliente->SortUrl($cliente->descripcion) == "") { ?>
		<th data-name="descripcion"><div id="elh_cliente_descripcion" class="cliente_descripcion"><div class="ewTableHeaderCaption"><?php echo $cliente->descripcion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="descripcion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->descripcion) ?>',1);"><div id="elh_cliente_descripcion" class="cliente_descripcion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cliente->descripcion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($cliente->descripcion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cliente->descripcion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_idCliente" class="cliente_idCliente">
<span<?php echo $cliente->idCliente->ViewAttributes() ?>>
<?php echo $cliente->idCliente->ListViewValue() ?></span>
</span>
...
<?php echo $cliente->nit->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($cliente->cliente->Visible) { // cliente ?>
		<td data-name="cliente"<?php echo $cliente->cliente->CellAttributes() ?>>
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_cliente" class="cliente_cliente">
<span<?php echo $cliente->cliente->ViewAttributes() ?>>
<?php echo $cliente->cliente->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($cliente->direccion->Visible) { // direccion ?>
		<td data-name="direccion"<?php echo $cliente->direccion->CellAttributes() ?>>
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_direccion" class="cliente_direccion">
<span<?php echo $cliente->direccion->ViewAttributes() ?>>
<?php echo $cliente->direccion->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($cliente->telefono->Visible) { // telefono ?>
		<td data-name="telefono"<?php echo $cliente->telefono->CellAttributes() ?>>
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_telefono" class="cliente_telefono">
...
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_estado" class="cliente_estado">
<span<?php echo $cliente->estado->ViewAttributes() ?>>
<?php echo $cliente->estado->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($cliente->tipo->Visible) { // tipo ?>
		<td data-name="tipo"<?php echo $cliente->tipo->CellAttributes() ?>>
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_tipo" class="cliente_tipo">
<span<?php echo $cliente->tipo->ViewAttributes() ?>>
<?php echo $cliente->tipo->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($cliente->descripcion->Visible) { // descripcion ?>
		<td data-name="descripcion"<?php echo $cliente->descripcion->CellAttributes() ?>>
<span id="el<?php echo $cliente_list->RowCnt ?>_cliente_descripcion" class="cliente_descripcion">
<span<?php echo $cliente->descripcion->ViewAttributes() ?>>
<?php echo $cliente->descripcion->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
