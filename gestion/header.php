...
var EW_MIN_PASSWORD_STRENGTH = 10;
var EW_GENERATE_PASSWORD_LENGTH = 5;
...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("icon.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("icon.ico") ?>">
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/logo.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
