...
fclienteview.Lists["x_tipo"] = {"LinkField":"x_idClienteTipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($cliente->cliente->Visible) { // cliente ?>
	<tr id="r_cliente">
		<td><span id="elh_cliente_cliente"><?php echo $cliente->cliente->FldCaption() ?></span></td>
...
<?php echo $cliente->cliente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $cliente->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
