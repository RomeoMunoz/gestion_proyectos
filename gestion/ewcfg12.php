...
define("EW_PROJECT_NAME", "projecto_final_is_umg", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{4744AE7F-D0AE-4DE0-9BB4-73B8ABE765D6}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Z5bvQUcNzt3SVqa3', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/projecto_final_is_umg.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "nd", "db" => "proyecto", "qs" => "`", "qe" => "`");
...
define("EW_SESSION_TIMEOUT_COUNTDOWN", 7200, TRUE); // Session timeout count down interval (seconds)
...
define("EW_ADMIN_PASSWORD", "manager", TRUE); // Administrator password
