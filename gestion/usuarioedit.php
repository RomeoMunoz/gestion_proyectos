...
class cusuario_edit extends cusuario {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// tipoUsuario
			$this->tipoUsuario->SetDbValueDef($rsnew, $this->tipoUsuario->CurrentValue, NULL, $this->tipoUsuario->ReadOnly);

			// estado
			$this->estado->SetDbValueDef($rsnew, $this->estado->CurrentValue, NULL, $this->estado->ReadOnly);

			// tipoIngreso
			$this->tipoIngreso->SetDbValueDef($rsnew, $this->tipoIngreso->CurrentValue, NULL, $this->tipoIngreso->ReadOnly);

			// grupo
			$this->grupo->SetDbValueDef($rsnew, $this->grupo->CurrentValue, NULL, $this->grupo->ReadOnly);

			// etiquetas
			$this->etiquetas->SetDbValueDef($rsnew, $this->etiquetas->CurrentValue, NULL, $this->etiquetas->ReadOnly);

			// iniciales
			$this->iniciales->SetDbValueDef($rsnew, $this->iniciales->CurrentValue, NULL, $this->iniciales->ReadOnly);

			// sueldo
			$this->sueldo->SetDbValueDef($rsnew, $this->sueldo->CurrentValue, NULL, $this->sueldo->ReadOnly);

			// tipoSueldo
			$this->tipoSueldo->SetDbValueDef($rsnew, $this->tipoSueldo->CurrentValue, NULL, $this->tipoSueldo->ReadOnly);

			// horaExtra
			$this->horaExtra->SetDbValueDef($rsnew, $this->horaExtra->CurrentValue, NULL, $this->horaExtra->ReadOnly);
...
fusuarioedit.Lists["x_tipoUsuario"] = {"LinkField":"x_idUsuarioTipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioedit.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioedit.Lists["x_estado"].Options = <?php echo json_encode($usuario->estado->Options()) ?>;
fusuarioedit.Lists["x_tipoIngreso"] = {"LinkField":"x_idIngresoTipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioedit.Lists["x_tipoSueldo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioedit.Lists["x_tipoSueldo"].Options = <?php echo json_encode($usuario->tipoSueldo->Options()) ?>;
fusuarioedit.Lists["x_empresa"] = {"LinkField":"x_idEmpresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioedit.Lists["x_userlevelid"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<div class="ewDesktop">
<div>
<table id="tbl_usuarioedit" class="table table-bordered table-striped ewDesktopTable">
...
<p class="form-control-static"><?php echo $usuario->idUsuario->EditValue ?></p></span>
</span>
<input type="hidden" data-table="usuario" data-field="x_idUsuario" name="x_idUsuario" id="x_idUsuario" value="<?php echo ew_HtmlEncode($usuario->idUsuario->CurrentValue) ?>">
<?php echo $usuario->idUsuario->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<input type="password" data-password-strength="pst_password" data-password-generated="pgt_password" data-table="usuario" data-field="x_password" name="x_password" id="x_password" value="<?php echo $usuario->password->EditValue ?>" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($usuario->password->getPlaceHolder()) ?>"<?php echo $usuario->password->EditAttributes() ?>>
...
<select data-table="usuario" data-field="x_estado" data-value-separator="<?php echo ew_HtmlEncode(is_array($usuario->estado->DisplayValueSeparator) ? json_encode($usuario->estado->DisplayValueSeparator) : $usuario->estado->DisplayValueSeparator) ?>" id="x_estado" name="x_estado"<?php echo $usuario->estado->EditAttributes() ?>>
<?php
if (is_array($usuario->estado->EditValue)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = ew_SameStr($usuario->estado->CurrentValue, $arwrk[$rowcntwrk][0]) ? " selected" : "";
		if ($selwrk <> "") $emptywrk = FALSE;		
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $usuario->estado->DisplayValue($arwrk[$rowcntwrk]) ?>
</option>
<?php
	}
	if ($emptywrk && strval($usuario->estado->CurrentValue) <> "") {
?>
<option value="<?php echo ew_HtmlEncode($usuario->estado->CurrentValue) ?>" selected><?php echo $usuario->estado->CurrentValue ?></option>
<?php
    }
}
?>
...
<?php echo $usuario->estado->CustomMsg ?></td>
	</tr>
<?php } ?>
